                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received XCRC from zXCRC"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zXCRC"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zXLR));
