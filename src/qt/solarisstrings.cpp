...
QT_TRANSLATE_NOOP("solaris-core", "Copyright (C) 2015-%i The CRyptoCrowd Core Developers"),
...
QT_TRANSLATE_NOOP("solaris-core", "Error loading wallet.dat: Wallet requires newer version of CRyptoCrowd Core"),
...
QT_TRANSLATE_NOOP("solaris-core", "Initialization sanity check failed. CRyptoCrowd Core is shutting down."),
...
QT_TRANSLATE_NOOP("solaris-core", "Wallet needed to be rewritten: restart CRyptoCrowd Core to complete"),
