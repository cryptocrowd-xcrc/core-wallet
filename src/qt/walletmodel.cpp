...
static void NotifyzXLRReset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzXLRReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzXLRReset.connect(boost::bind(NotifyzXLRReset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzXLRReset.disconnect(boost::bind(NotifyzXLRReset, this));
...
{
    setMints.clear();
    setMints = pwalletMain->zxlrTracker->ListMints(fUnusedOnly, fMaturedOnly, fUpdateStatus, fWrongSeed);
}
