                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzXLRPathCustom = GetArg("-zxlrbackuppath", "");
    ...
    if(!strzXLRPathCustom.empty()) {
        ui->wallet_customzxlrbackuppath->setText(QString::fromStdString(strzXLRPathCustom));
        ui->wallet_customzxlrbackuppath_label->setVisible(true);
        ui->wallet_customzxlrbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzXLRPathCustom.empty()) && nCustomBackupThreshold > 0) {
