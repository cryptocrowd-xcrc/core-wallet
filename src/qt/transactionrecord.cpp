...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zxlrTracker->HasMintTx(hash))) {
            //zXLR stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZXLR;
...
bool IsZXLRType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZXLR:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZXLR || type == TransactionRecord::MNReward) {
