...
extern UniValue setzxlrseed(const UniValue& params, bool fHelp);
extern UniValue getzxlrseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzxlr(const UniValue& params, bool fHelp);
extern UniValue dzxlrstate(const UniValue& params, bool fHelp);
