...
#ifndef Solaris_ZXLRWALLET_H
#define Solaris_ZXLRWALLET_H
...
public:
    CzXLRWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZXLR(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZXLR(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
