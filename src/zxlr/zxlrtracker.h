...
#ifndef Solaris_ZXLRTRACKER_H
#define Solaris_ZXLRTRACKER_H
...
public:
    CzXLRTracker(std::string strWalletFile);
    ~CzXLRTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzXLRWallet* zXLRWallet = NULL);
