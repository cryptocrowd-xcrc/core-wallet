...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "solaris.seed.fuzzbawls.pw"));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "solaris.seed2.fuzzbawls.pw"));    // Secondary DNS Seeder from Fuzzbawls
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zxlr to be stakable
