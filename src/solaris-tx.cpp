...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CRyptoCrowd Core xcrc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xcrc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptocrowd transaction") + "\n" +
                               "  xcrc-tx [options] -create [commands]   " + _("Create hex-encoded cryptocrowd transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptocrowd transaction
