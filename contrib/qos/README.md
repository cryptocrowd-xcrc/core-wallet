...
This means one can have an always-on xcrcd instance running, and another local xcrcd/cryptocrowd-qt instance which connects to this node and receives blocks from it.
