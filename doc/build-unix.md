UNIX BUILD NOTES
====================
Some notes on how to build Solaris in Unix.
...
memory available when compiling Solaris Core. With 512MB of memory or less
...
above instead of `libssl-dev`. Solaris Core does not support the use of OpenSSL 1.1, though compilation is still possible
...
# Configure Solaris Core to use our own-built instance of BDB
cd $Solaris_ROOT
...
Security
--------
To help make your Solaris installation more secure by making certain attacks impossible to
...
When the intention is to run only a P2P node without a wallet, Solaris Core may be compiled in
