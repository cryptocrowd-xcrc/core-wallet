...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/Solaris-Project/CRyptoCrowd/blob/master/doc/translation_process.md#synchronising-translations).
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/Solaris-Project/CRyptoCrowd/releases/new) with a link to the archived release notes.
