...
In order to support loading of multiple wallets in cryptocrowd-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cryptocrowd.cpp.
...
Changes to cryptocrowd.cpp
----------------------
cryptocrowd.cpp is the entry point into cryptocrowd-qt, and as such, will require some minor modifications to provide hooks for
