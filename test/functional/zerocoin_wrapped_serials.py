#!/usr/bin/env python3
# Copyright (c) 2019 The Solaris Core developers
...
from fake_stake.base_test import Solaris_FakeStakeTest

class zXLRwrappedSerialsTest(Solaris_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zXLRs..." % DENOM_TO_USE)
