Contributing to CRyptoCrowd Core
============================

The CRyptoCrowd Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CRyptoCrowd Core project, and is not to be
confused with overall CRyptoCrowd Network Protocol consensus changes.

Whether a pull request is merged into CRyptoCrowd Core rests with the project merge
...
Patches that change CRyptoCrowd consensus rules are considerably more involved than
...
Where a patch set proposes to change the CRyptoCrowd consensus, it must have been
...
The project leader is the release manager for each CRyptoCrowd Core release.
